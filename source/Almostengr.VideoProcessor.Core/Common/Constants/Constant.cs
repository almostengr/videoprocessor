...
{
    public static readonly string BorderBox = "box=1:";
    public static readonly string CommaSpace = ", ";
    public static readonly string DoubleWhitespace = "  ";
    ...
    public static readonly string ArgumentCannotBeNullOrEmpty = "Argument cannot be null or empty";

    public static readonly string NissanAltima = "nissan altima";
    public static readonly string GmcSierra = "gmc sierra";
}
