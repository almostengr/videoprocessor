    ...
    public class DashCamVideoService : VideoService, IDashCamVideoService
    {
        ...
        public override async Task ExecuteServiceAsync(CancellationToken cancellationToken)
        {
            while (!cancellationToken.IsCancellationRequested)
            {
                ...
                try
                {
                    ...
                    await _fileSystemService.ConfirmFileTransferCompleteAsync(videoArchivePath);
                    ...
                    _fileSystemService.DeleteFile(videoArchivePath);
        ...
        protected override void CheckOrCreateFfmpegInputFile()
        {
            ...
            using (StreamWriter writer = new StreamWriter(ffmpegInputFile))
            {
                ...
                string[] mp4Files = _fileSystemService.GetFilesInDirectory(_workingDirectory)
